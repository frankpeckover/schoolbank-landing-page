...
- `assets/screenshot-dashboard.png` and `assets/screenshot-users.png` are screenshots from the app used by the page.
...
- `assets/screenshot-dashboard.png` for the hero and analytics sections.
